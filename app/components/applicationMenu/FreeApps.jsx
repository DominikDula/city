...
const FreeApps = () => {
  return (
    <div className=" border-t-1 border-border-main dark:border-border-main-dark">
      <h2 className="font-semibold text-sm text-t-main dark:text-t-main-dark hover:text-t-main-hover dark:hover:text-t-main-hover-dark px-4 mb-4 pt-5">Aplikácie zdarma</h2>
      <div className="grid grid-cols-4 mt-4 px-4 w-full">
        {[
